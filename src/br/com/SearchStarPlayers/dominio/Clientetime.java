 ...
 * @author internet
 */
public class Clientetime extends Usuario{
    ...
    private List<Servidor> produtosFornecidos;
    ...
    public List<Servidor> getProdutosFornecidos() {
        return produtosFornecidos;
    }

    public void setProdutosFornecidos(List<Servidor> produtosFornecidos) {
    ...
    public boolean equals(Object obj) {
        ...
        final Clientetime other = (Clientetime) obj;
        if (this.id != other.id) {
            return false;
        }
